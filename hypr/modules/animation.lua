...
hl.animation({ leaf = "layersIn", enabled = true, speed = 5, bezier = "overshot", style = "slide right" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 5, bezier = "ease", style = "slide left" })
