...
QtObject {
    ...
    readonly property string cacheDir: home + "/.cache/wallpaper-picker"
    readonly property string stateDir: home + "/.local/state/wallpaper-picker"
    readonly property string runDir: (xdgRuntimeDir !== "" ? xdgRuntimeDir : "/tmp") + "/wallpaper-picker"
